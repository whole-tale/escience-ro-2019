...
% BL: unified capitalization of keywords 
\begin{IEEEkeywords}
...
% BL: We introduce "WT" in the next para, but then never seem to use it .. 
...
% BL: capitalizing proper names (Section I, II ..)
...
% BL: There was a footnote linking to the bdbag-ro-profile.json which
% was NOT working => I moved the footnote out of the table and
% adjusted the footnote to make it work. Note: otherwise we would have
% had the rather surprising sequence of footnotes 1,2,3,4,6, .. 
% see: the missing footnote 5 in the earlier version: https://github.com/whole-tale/escience-ro-2019/blob/c706e8b16d801132b75c8aa0733dd0a7a46680bd/escience-ro-2019.pdf
...
% BL: should be Dataverse network members [note the plural] ? 
    ...
    identifiers).  
% BL: the next sentence seems to be redundant with the previous one !? 
...
% BL: Should add refs to DataCite and schema.org in the preceeding sentence, right? 
...
be included here. 
% BL: We cite Prov-ONE twice in footnotes => turned into proper ref.
...
% Our efforts are more general than ReproZip, which gathers and bundles
% dependencies for command line executions \cite{Chirigati2016}.
% BL: I tried to soften the "more general than" claim a bit as
% follows: 
...
% self-contained bundles guaranteed to re-execute regardless of  
% BL: I softened the guaranteed here as follows: 
